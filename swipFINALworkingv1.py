# @title SWIP - swap and IP adapter
...
parser.add_argument(
    "--out_dir", help="Default Output directory", default="/content/output"
)
...
DEF_OUTPUT_PATH = os.path.join(user_args.out_dir)
...
def process(
    ...
    *specifics,
    ...
    def swap_process(image_sequence):
        ...
        analysed_targets, analysed_sources, whole_frame_list, num_faces_per_frame = (
            get_analysed_data(
                FACE_ANALYSER,
                image_sequence,
                source_data,
...
# @title IP adapter Face ID plus to depthmaps gradio app DO NOT MODIFY OR DELETE!!!
...
def generate_image(
    ...
    # base_model_path = "stablediffusionapi/real-cartoon-3d"
    # base_model_path = "OlafII/papercutcraft-v1"

    vae_model_path = "stabilityai/sd-vae-ft-mse"
    image_encoder_path = "laion/CLIP-ViT-H-14-laion2B-s32B-b79K"
    ip_ckpt = (
        "/content/swap/Swapm/ip-adapter-faceid-plus_sd15.bin"
        if not v2
                ...
                with gr.Column(scale=0.4):
                    ...
                    with gr.Tab("📤 Output Settings"):
                        output_directory = gr.Text(
                            label="Output Directory - set as /content/output",
